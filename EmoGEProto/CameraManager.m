...
//        [self setupAVCapture:AVCaptureSessionPreset640x480];
        NSString *cameraResolutions = [CameraManager cameraResolutions];
        if (cameraResolutions) {
            [self setupAVCapture:cameraResolutions];
        }
        return self;
    }
    return nil;
...
+ (NSString *)cameraResolutions {
    NSString* deviceModel = [CameraManager deviceModel];
